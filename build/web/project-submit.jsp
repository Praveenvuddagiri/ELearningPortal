        ...
        <div class="card text-center shadow" style="margin: 8% 25% 8% 25%;">
            <div class="card-body">
                <form action="">
                    ...
                    <p class="card-text" style="padding-bottom: 2%;">With supporting text below as a natural lead-in to
                        additional content.</p>
                    <label class="form-label" for="customFile">Upload your file here</label>
                    <input type="file" class="form-control" id="customFile" style="margin-bottom: 30px;" />
                    <a href="#" class="btn btn-success" style="margin-bottom: 3%;"><i class="fa-solid fa-upload"></i> Upload</a>
                </form>
            </div>
        </div>
    </div>
